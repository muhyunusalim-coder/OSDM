      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200/80 dark:border-gray-800 overflow-hidden">
        <div className="p-4 md:p-5 border-b border-gray-200 dark:border-gray-800 flex flex-col xl:flex-row xl:items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex flex-col md:flex-row gap-2.5 flex-wrap">
            ...
            >
              <Search
                className={`absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none transition-colors ${searchTerm !== "" ? "text-rose-600 dark:text-rose-400" : "text-gray-500 dark:text-gray-400"} group-focus-within:text-rose-500 dark:group-focus-within:text-rose-400`}
                size={16}
              />
              <input
                type="text"
            ...
            <div className="flex gap-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 no-scrollbar">
              <select
                className="w-full md:w-auto px-3.5 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-500/10 focus:border-rose-500 dark:focus:border-rose-400 text-xs bg-gray-50 dark:bg-gray-800 font-bold text-gray-700 dark:text-gray-200 cursor-pointer transition-all hover:bg-white dark:hover:bg-gray-900"
                value={statusFilter}
