              ...
              <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 sm:gap-8 py-1 sm:py-2">
                ...
                >
                  <div className="relative z-10 flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-700/80 border border-gray-200 dark:border-gray-600 flex items-center justify-center shrink-0 text-primary-600 dark:text-primary-400 mt-0.5 shadow-sm">
                      <Building size={18} />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase st mb-2">
                        Info & Inspirasi
                      </p>
                      <div className="min-h-[48px] relative overflow-hidden flex items-start">
                        <>
                          <p
                            ...
                            className="text-[13px] text-gray-700 dark:text-gray-200 font-medium leading-relaxed"
                          >
        ...
        <>
          {selectedReg && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-2xl w-full max-w-xl overflow-hidden relative z-10">
                <div className="p-6 md:p-8 relative">
                  {/* Close Button */}
                  <button
                    onClick={() => setSelectedReg(null)}
                    className="absolute top-6 right-6 p-2 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-full transition-all active:scale-95 cursor-pointer"
                  >
                    <X size={16} />
                  </button>

                  <div className="mb-6">
                    <span className="inline-block bg-primary-50 dark:bg-primary-500/10 text-primary-700 dark:text-primary-400 border border-primary-100 dark:border-primary-800 rounded-lg px-2.5 py-1 text-[10px] font-bold st font-mono mb-2">
                      {selectedReg.code}
                    </span>
                    <h3 className="text-gray-900 dark:text-gray-100 font-black text-xl leading-snug ">
                      {selectedReg.title}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 text-xs font-semibold mt-1">
                      {selectedReg.subtitle}
                    </p>
                  </div>

                  <div className="space-y-4">
                    <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-700">
                      <h4 className="text-[10px] text-gray-600 dark:text-gray-400 font-extrabold uppercase st mb-1.5 font-mono">
                        Ringkasan Regulasi
                      </h4>
                    ...
                    <div>
                      <h4 className="text-[10px] text-gray-600 dark:text-gray-400 font-extrabold uppercase st mb-3 font-mono flex items-center gap-1.5">
                        <CheckCircle
                          className="text-primary-500 dark:text-primary-400"
                          size={13}
                        />{" "}
                        Poin Pokok Perubahan
                      </h4>
                  ...
                  <div className="mt-8 pt-5 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-3">
                    <button
                      onClick={() => setSelectedReg(null)}
                      className="px-5 py-2.5 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold text-xs rounded-xl transition-all active:scale-95 cursor-pointer border border-gray-200 dark:border-gray-700"
                    >
                      Tutup Regulasi
                    </button>
                    <button
