    ...
    <div className={`space-y-6 w-full px-1 md:px-2 ${selectedRecord ? 'print:hidden' : ''}`}>
      ...
      <div className="bg-gray-900 dark:bg-gray-800 rounded-3xl p-6 md:p-8 text-white relative overflow-hidden shadow-xl border border-primary-500/10 print:hidden">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          ...
          {/* Quick Rules Sheet */}
          <div className="bg-gray-800/80 border border-primary-500/20 rounded-2xl p-4 md:p-5 max-w-md space-y-3.5 shrink-0 text-gray-200 shadow-lg">
            <h3 className="text-xs font-bold text-white flex items-center gap-2 uppercase r pb-1.5 border-b border-white/10">
            ...
            <div className="grid grid-cols-2 gap-3.5 text-[11px]">
              <div className="space-y-1">
                ...
                <span className="block text-gray-300 font-medium">{t('break')}: 60 m</span>
                <span className="block text-gray-300 font-medium">{t('max_checkout')}: 17:00</span>
              </div>
              <div className="space-y-1">
                ...
                <span className="block text-gray-300 font-medium">{t('break')}: 90 m</span>
                <span className="block text-gray-300 font-medium">{t('max_checkout')}: 17:30</span>
              </div>
            </div>
            <div className="text-[10px] text-gray-300 font-medium pt-1.5 border-t border-white/10 space-y-1.5">
