...
const ComparisonChart: React.FC<Props> = React.memo(({ employees, language }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200/80 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden flex flex-col justify-between group mt-6">
      <div className="absolute top-0 right-0 w-64 h-64 from-primary-500/5 dark:from-primary-500/10 to-transparent rounded-full blur-[40px] pointer-events-none -mr-20 -mt-20"></div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        {/* Toggle pill buttons */}
        <div className="flex items-center bg-gray-100 dark:bg-gray-800 p-1 rounded-xl self-start sm:self-auto border border-gray-200/40 dark:border-gray-700/50 relative z-10">
          <button
            ...
            className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all duration-200 cursor-pointer ${
              comparisonTab === 'unit'
                ? 'bg-white dark:bg-gray-900 text-primary-600 dark:text-primary-400 shadow-sm shadow-primary-100 dark:shadow-none'
