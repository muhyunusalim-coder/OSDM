...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Ya, KGB dapat ditunda apabila PNS yang bersangkutan belum memenuhi syarat kecakapan atau penilaian kinerjanya di bawah predikat 'Baik'. Penundaan dilakukan paling lama 1 (satu) tahun dengan Surat Keputusan Penundaan. Apabila masa penundaan selesai dan pegawai dinilai berkelakuan baik, KGB akan diberikan terhitung mulai bulan berikutnya.",
  },
  {
    category: "kgb",
    question:
      "Bagaimana perhitungan KGB untuk Pegawai Pemerintah dengan Perjanjian Kerja (PPPK)?",
    answer:
      "Berdasarkan Permenpan-RB No. 7 Tahun 2023, PPPK juga berhak mendapatkan KGB setelah memenuhi masa kerja golongan yang ditentukan (umumnya 2 tahun sekali) dan memiliki nilai kinerja minimal 'Baik' pada tahun terakhir kontrak yang berjalan.",
  },
  {
    category: "kgb",
    question:
      "Apa dampak keterlambatan pengurusan KGB terhadap pembayaran gaji?",
    answer:
      "Keterlambatan usulan KGB tidak akan menghapus hak pegawai, namun akan menunda penyesuaian pembayaran gaji pokok baru pada daftar gaji bulanan. Setelah SK KGB diterbitkan, pembayaran selisih kenaikan gaji (gaji rapel) akan dibayarkan terhitung sejak TMT berlakunya KGB tersebut.",
  },
  // KP
  {
    category: "kp",
  ...
  },
  {
    category: "kp",
    question:
      "Apa perbedaan Kenaikan Pangkat Reguler dengan Kenaikan Pangkat Pilihan?",
    answer:
  ...
  },
  {
    category: "kp",
    question:
      "Apa saja berkas utama yang wajib diunggah untuk Kenaikan Pangkat Jabatan Fungsional?",
    answer:
      "Untuk Pejabat Fungsional di lingkungan BSKJI, berkas wajib meliputi: (1) SK Pangkat Terakhir, (2) SK Kenaikan Jabatan Fungsional (bila ada kenaikan jenjang), (3) Penetapan Angka Kredit (PAK) Konversi terbaru, (4) Sasaran Kinerja Pegawai (SKP) 2 tahun terakhir, dan (5) Surat Pengantar Usulan dari Unit Kerja.",
  },
  {
    category: "kp",
    question:
      "Apakah nilai SKP 'Cukup' diperbolehkan untuk usulan Kenaikan Pangkat?",
    answer:
      "Tidak diperbolehkan. Sesuai dengan Peraturan Pemerintah No. 11 Tahun 2017 tentang Manajemen PNS, salah satu syarat mutlak Kenaikan Pangkat adalah memiliki penilaian prestasi kerja / SKP dengan predikat paling rendah bernilai 'Baik' dalam 2 (dua) tahun terakhir berturut-turut.",
  },
  // Pensiun
  {
    category: "pensiun",
    question:
      "Berapa Batas Usia Pensiun (BUP) bagi Aparatur Sipil Negara (ASN)?",
    answer:
      "Sesuai UU No. 20 Tahun 2023 tentang ASN, BUP terbagi atas: (1) 58 Tahun bagi Pejabat Administrasi, Pejabat Fungsional Ahli Pertama, Ahli Muda, dan Keterampilan. (2) 60 Tahun bagi Pejabat Pimpinan Tinggi Pratama, Ahli Madya, Guru, dan Dosen. (3) 65 Tahun bagi Pejabat Fungsional Ahli Utama. (4) 70 Tahun bagi Pejabat Fungsional Peneliti atau Perekayasa Ahli Utama.",
  },
  {
    category: "pensiun",
    question: "Kapan sebaiknya berkas administrasi pensiun mulai diurus?",
    answer:
      "Pegawai disarankan mulai melengkapi dan mengajukan usulan berkas pensiun 6 hingga 12 bulan sebelum tanggal mencapai Batas Usia Pensiun (BUP). Hal ini penting untuk memastikan SK Pensiun dan hak tabungan hari tua (TASPEN) terbit tepat waktu sebelum pegawai berhenti bekerja.",
  },
  {
    category: "pensiun",
    question: "Apa saja dokumen wajib untuk pengusulan Pensiun BUP?",
    answer:
      "Dokumen wajib yang harus diunggah di antaranya: (1) SK CPNS dan PNS, (2) SK Pangkat Terakhir, (3) SK Jabatan Terakhir, (4) SKP 2 tahun terakhir, (5) Daftar Susunan Keluarga terlegalisir, (6) Akta Nikah/Cerai, (7) Surat Pernyataan Bebas dari Proses Pidana/Hukuman Disiplin, dan (8) Pasfoto terbaru.",
  },
  // SIASN
  {
    category: "siasn",
  ...
  },
  {
    category: "siasn",
    question:
      "Apakah penandatanganan SK Layanan Kepegawaian saat ini sudah menggunakan TTE?",
    answer:
      "Ya. Sejalan dengan pilar transformasi digital Kementerian Perindustrian, seluruh SK Kenaikan Gaji Berkala (KGB), Kenaikan Pangkat, dan Pensiun saat ini sudah menggunakan Tanda Tangan Elektronik (TTE) bersertifikat BSrE BSSN yang sah dan terintegrasi penuh dalam sistem.",
  },
];
...
export const FAQPage: React.FC<FAQPageProps> = React.memo(({ employees }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-5 duration-500 pb-4">
      ...
      <div className="bg-primary-50 dark:bg-gray-800 rounded-2xl p-6 md:p-8 shadow-md relative overflow-hidden text-white border border-primary-800/40">
        <div className="relative z-10 max-w-3xl">
          <span className="inline-flex items-center gap-1.5 bg-primary-500/10 text-primary-300 border border-primary-500/20 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase r mb-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-200/60 dark:border-gray-800 p-6 md:p-8 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 border-b border-gray-100 dark:border-gray-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100 ">
                    Daftar Pertanyaan Umum Kepegawaian
                  </h2>
                  <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                    Temukan penjelasan akurat mengenai administrasi kepegawaian.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-4 py-2 w-full sm:w-64 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl text-xs font-semibold focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/10 transition-all placeholder-gray-400 dark:placeholder-gray-500 text-gray-800 dark:text-gray-100"
                />
              </div>
            </div>
                ...
                <button
                  ...
                  className={`px-4 py-2 text-xs font-bold rounded-xl whitespace-nowrap transition-all border cursor-pointer shrink-0 ${
                    activeTab === cat.id
                      ...
                      : "bg-gray-50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800/80 hover:text-gray-900 dark:hover:text-gray-100"
                  }`}
                >
                  {cat.label}
                </button>
              ...
              {filteredFAQs.length > 0 ? (
                    ...
                    <div
                      ...
                      className={`rounded-2xl border transition-all duration-300 ${
                        isOpen
                          ...
                          : "border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:border-gray-200 dark:hover:border-gray-700"
                      }`}
                    >
                      <button
                      ...
                      >
                        <span
                          className={`font-bold text-xs sm:text-sm leading-snug ${isOpen ? "text-primary-800 dark:text-primary-300" : "text-gray-800 dark:text-gray-100"}`}
                        >
                          {item.question}
                        </span>
                        <span
                          className={`p-1.5 rounded-full shrink-0 transition-colors ${isOpen ? "bg-primary-100 dark:bg-primary-900/50 text-primary-600 dark:text-primary-400" : "bg-gray-50 dark:bg-gray-800/50 text-gray-500 dark:text-gray-400"}`}
                        >
                          {isOpen ? (
                            <ChevronUp size={14} />
                          ) : (
                      ...
                      {isOpen && (
                        <div className="px-5 pb-5 pt-0 animate-in fade-in slide-in-from-top-1 duration-200">
                          <div className="h-px w-full bg-gray-100 dark:bg-gray-800/50 mb-3.5"></div>
                          <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-xs sm:text-sm font-medium">
                            {item.answer}
                          </p>
                        </div>
                      )}
                ...
                <div className="text-center py-12 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-1">
                    Coba sesuaikan kata kunci atau bersihkan pencarian Anda.
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-[2rem] shadow-sm border border-gray-200/60 dark:border-gray-800 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-24 h-24 bg-amber-50 dark:bg-amber-950/20 rounded-full pointer-events-none -mr-8 -mt-8"></div>
            ...
            <div className="flex items-center gap-3 mb-5 border-b border-gray-100 dark:border-gray-800 pb-3">
              ...
              <div>
                <h3 className=" font-bold text-gray-800 dark:text-gray-100 text-sm uppercase r">
                  Dasar Hukum & Dokumen
                </h3>
                <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium">
                  Unduh draf regulasi resmi kepegawaian nasional.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
              {REGULATIONS.map((reg, idx) => (
                <a
                  ...
                  className="flex gap-3.5 p-3 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 hover:border-primary-200 hover:bg-primary-50/20 transition-all group cursor-pointer items-start relative"
                >
                  <div className="absolute top-3.5 right-3.5 text-gray-400 dark:text-gray-500 group-hover:text-primary-500 transition-colors opacity-0 group-hover:opacity-100">
                    <Download size={14} />
                  </div>

                  <div className="mt-1 p-1 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shrink-0 group-hover:border-primary-100">
                    <FileText
                      size={16}
                  ...
                  <div className="pr-4">
                    <span className="inline-block bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 group-hover:bg-primary-50 group-hover:text-primary-700 text-[8px] font-bold px-1.5 py-0.5 rounded font-mono mb-1">
                      {reg.code}
                    </span>
                    <h4 className="font-bold text-gray-800 dark:text-gray-100 text-xs mb-0.5 group-hover:text-primary-700 dark:group-hover:text-primary-400 leading-snug flex items-center gap-1">
                      {reg.title}
                      <ExternalLink
                        size={9}
                        className="text-gray-400 dark:text-gray-500 group-hover:text-primary-400 shrink-0"
                      />
                    </h4>
                    <p className="text-[10px] text-gray-600 dark:text-gray-300 leading-relaxed line-clamp-2">
                      {reg.desc}
                    </p>
                    <p className="text-[8px] text-gray-500 dark:text-gray-400 font-bold font-mono mt-1.5">
                      {reg.type} &bull; {reg.size}
                    </p>
                  </div>
                </a>
              ))}
